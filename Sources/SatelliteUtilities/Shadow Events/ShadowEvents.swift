/*╔══════════════════════════════════════════════════════════════════════════════════════════════════╗
  ║ ShadowEvents.swift                                                            SatelliteUtilities ║
...
/*┌──────────────────────────────────────────────────────────────────────────────────────────────────┐
  ...
  └──────────────────────────────────────────────────────────────────────────────────────────────────┘*/
    @MainActor public static func calculateShadowEvents(
        ...
        // A correction I made for the result to work properly
...
public struct ShadowEventResult: Equatable, Hashable, Codable, Sendable {
